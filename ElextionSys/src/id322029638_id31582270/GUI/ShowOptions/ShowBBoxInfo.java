...
import id322029638_id31582270.GUI.ShowOptions.Tabels.ShowBBoxInfoTableView;
...
public class ShowBBoxInfo extends Button {
	VBox addViewPane;
	ArrayList<ElectionUIListenable> listners;

	public ShowBBoxInfo(ArrayList<ElectionUIListenable> listners, StackPane bgPane) {
		...
		Label lblTitle = new Label("Show Box Info");
		lblTitle.setFont(new Font("Curve", 35));
		addViewPane.getChildren().add(lblTitle);

		ShowBBoxInfoTableView<BBox<?>> tvBoxes = new ShowBBoxInfoTableView<BBox<?>>(
